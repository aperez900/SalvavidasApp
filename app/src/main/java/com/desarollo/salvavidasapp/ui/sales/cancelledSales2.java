...
public class cancelledSales2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cancelled_sales2);
        ...
        listSellAdapter = new ListSellAdapter(this,listaDeDatos, cancelledSales2.this);
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            listSellAdapter = new ListSellAdapter(cancelledSales2.this,listaDeDatos, cancelledSales2.this);
                            listado.setAdapter(listSellAdapter);
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(cancelledSales2.this, "Error cargando los productos", Toast.LENGTH_SHORT).show();
                    }
                });
    }
}